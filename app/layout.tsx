...
export const metadata: Metadata = {
  title: "AI Website Builder – Create Stunning Websites Instantly",
  description:
    "Build professional websites in seconds with AI. Choose from business, portfolio, restaurant, shop, and more templates. Free to use.",
  keywords: "website builder, AI, free website, business website, portfolio",
};
